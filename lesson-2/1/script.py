...
# и поместить в него названия столбцов отчета в виде списка: «Изготовитель системы»,
...
def get_data():
    ...
    data_for_rows = [os_prod_list, os_name_list, os_code_list, os_type_list]  # 4 списка по три элемента

    # тут всё переворачиваем, чтобы было нормально и приклеиваем к заголовкам
