...
# а также установить возможность работы с юникодом: allow_unicode = True; ВАЖНО: Реализовать считывание данных из
# созданного файла и проверить, совпадают ли они с исходными.

import yaml

DATA_IN = {'items': ['guitar', 'violin', 'piano', 'flute'],
           'items_quantity': 4,
           'items_price': {'guitar': '250€',
                           'violin': '500€',
                           'piano': '830€',
                           'flute': '750€'}
           }
